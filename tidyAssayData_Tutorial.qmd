...
### Import data
Load DNA microarray count data from a study in NCBI GEO database with accession number GSE158643   
...
### Import data 
Load DNA microarray count data from a study with accession number GSE55945 available on NCBI GEO database.
...
way to tidy up the column names of count data. Therefore it will be worth adding to your gene expression analysis toolkit.  
